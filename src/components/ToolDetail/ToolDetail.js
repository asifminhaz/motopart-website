...
const ToolDetail = () => {
  // const {data: products, isLoading} = useQuery('products', () => fetch('https://young-badlands-79031.herokuapp.com/product', {
  //   headers: {
  ...
  useEffect(() => {
    const url = `https://young-badlands-79031.herokuapp.com/tool/${toolId}`
    fetch(url)
      .then(res => res.json())
  ...
  const handleOrder = event => {
    ...
    fetch('https://young-badlands-79031.herokuapp.com/orders', {
      method: 'POST',
      headers: {
